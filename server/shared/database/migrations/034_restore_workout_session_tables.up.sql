...
CREATE INDEX IF NOT EXISTS idx_workout_sessions_user_date ON workout_sessions(user_id, start_time);

CREATE INDEX IF NOT EXISTS idx_skipped_workouts_user_id ON skipped_workouts(user_id);
CREATE INDEX IF NOT EXISTS idx_skipped_workouts_date ON skipped_workouts(skip_date);

CREATE INDEX IF NOT EXISTS idx_exercise_performances_session_id ON exercise_performances(session_id);
CREATE INDEX IF NOT EXISTS idx_exercise_performances_exercise_id ON exercise_performances(exercise_id);

CREATE INDEX IF NOT EXISTS idx_set_performances_performance_id ON set_performances(performance_id);
CREATE INDEX IF NOT EXISTS idx_set_performances_completed_at ON set_performances(completed_at);
