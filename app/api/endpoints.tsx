...
export const API = {
    recipe: {
        ...
        logs: {
            ...
            getByDate: (date: string) => ({ method: 'GET', url: `food-tracker/food-logs/date/${date}` }),
            getInRange: (startDate: string, endDate: string) => ({ method: 'GET', url: `food-tracker/food-logs/range/${startDate}/${endDate}` }),
        ...
        nutrition: {
            ...
            getWeeklySummary: (startDate: string) => ({ method: 'GET', url: `food-tracker/nutrition/weekly/${startDate}` }),
            getMonthlySummary: (year: number, month: number) => ({ method: 'GET', url: `food-tracker/nutrition/monthly/${year}/${month}` }),
